...
const projects = [
    ...
    },
    {
        ...
        description: "This is a web application game where the user needs to pick a country based on a prompt and if it is the same as the one selected by the machine then the game is over",
        image: "/projects/elimination_game.png",
        tags: ["Geospatial", "Front-End"],
        demoUrl: "/game",
    },
]
