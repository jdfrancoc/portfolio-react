...
// import Game from "@/components/Game";
// import GeoDetective from "@/components/GeoDetective";
// import HouseGuessr from "@/components/HouseGuessr";
// import { Layout } from "@/components/Layout";
...
//     id: "houseguessr",
//     label: "🏠 House Guessr",
//     description: "Guess the asking price of a real house listing — you have 5 attempts.",
//   },
// ];
...
//   // HouseGuessr doesn't need the countries data, so we don't block on it
//   const countriesNeeded = activeTab !== "houseguessr";
...
//         {/* Content */}
//         {countriesNeeded && loading && <p className="text-muted-foreground">Loading countries…</p>}
//         {countriesNeeded && error && <p className="text-red-500">Error: {error}</p>}

//         {/* House Guessr — no country data needed, render immediately */}
//         {activeTab === "houseguessr" && <HouseGuessr />}

//         {/* Country games — wait for data */}
//         {!loading && !error && (
//           <>
//             {activeTab === "elimination" && <Game countries={countries} />}
//             {activeTab === "detective" && <GeoDetective countries={countries} />}
